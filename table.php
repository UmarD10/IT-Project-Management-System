...
<link rel="stylesheet" type="text/css" href="style.css">
    ...
    <title>IT Project Manangement system</title>
</head>
<body>
...
<h2><center>Add Team Member name here<center></h2>
      ...
      if(is_array($user->readAll()) || is_object($user->readAll())){
        foreach($user->readAll() as $value){
          ...
          <tr>
            ...
            <td>
              <a href="table.php?action=update&id=<?php echo $value['id']; ?>">Edit</a> ||
              <a href="table.php?action=delete&id=<?php echo $value['id']; ?>">Delete</a>
            </td>
          </tr>
          <?php
        }
